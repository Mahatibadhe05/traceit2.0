    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          ...
          style: TextStyle(
            color: darkBlue,
            fontSize: Responsive.font(context, 6.67),
      ...
      body: ListView(
        ...
        children: [
            ...
            children: [
              ...
              ListTile(
                contentPadding: EdgeInsets.symmetric(
                  ...
                  vertical: Responsive.h(context, 6 / 844),
                ),
                ...
                leading: CircleAvatar(
                  ...
                  child: Icon(
                    Icons.person,
                    color: primaryBlue,
                    size: Responsive.font(context, 8.2),
                  ),
                ),
              ...
              ListTile(
                contentPadding: EdgeInsets.symmetric(
                  horizontal: Responsive.w(context, 16 / 390),
                  vertical: Responsive.h(context, 4 / 844),
                ),
          ...
          SizedBox(
            height: Responsive.h(context, 52 / 844),
                  ...
                  builder: (dialogContext) {
                    return AlertDialog(
                      title: Text(
                        "Log Out",
                        style: TextStyle(
                          fontSize: Responsive.font(dialogContext, 4.6),
                        ),
                      ),
                      ...
                      content: Text(
                        ...
                        style: TextStyle(
                          fontSize: Responsive.font(dialogContext, 3.8),
                        ),
                      ),
  ...
  Widget _sectionTitle(
    ...
    return Padding(
      padding: EdgeInsets.only(
        ...
        bottom: Responsive.h(context, 9 / 844),
      ),
